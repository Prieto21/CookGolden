...
router.get('/user/favoritos',async(req,res)=>{
    const fav = await pool.query('SELECT r.nombre, r.descripcion, r.img FROM favoritos f, recetas r, usuarios u WHERE f.id_receta = r.id_receta AND f.id_usuario = u.id_usuario AND u.id_usuario = 14;');
